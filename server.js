...
const steps = [{
    ...
    type: 'question',
    message: 'Настя Абросимова, привет! Ты знаешь меня. Я хочу сделать для тебя сюрприз.'
}, {
    type: 'question',
    ...
    type: 'question',
    message: 'Чтобы ты поверила в наше с тобой знакомство, я расскажу несколько фактов о тебе:'
}, {
    type: 'question',
    ...
    type: 'question',
    message: 'Отлично. В течение завтрашнего дня, ты получишь подсказку. А вечером я буду ждать тебя здесь в 21 час. Я расскажу тебе, кто я. Договорились?:)',
    answer: {
        type : 'variants',
        value: [{
            message: 'Конечно'
    ...
    type: 'question',
    message: 'Как я и обещал, сегодня я расскажу тебе кто я.'
}, {
    type: 'question',
    ...
    type: 'question',
    message: 'Настюх, ну а кто еще то???)'
}, {
